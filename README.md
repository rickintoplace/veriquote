...
The protocol is deliberately plain text (not JSON): it survives streaming,
markdown renderers, and weak models, and it degrades gracefully — `[n]`
citations remain human-readable even if a client ignores VeriQuote entirely.
